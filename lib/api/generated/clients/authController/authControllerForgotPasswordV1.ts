...
export async function authControllerForgotPasswordV1(
  data: AuthControllerForgotPasswordV1MutationRequest,
  headers?: AuthControllerForgotPasswordV1HeaderParams,
  config: Partial<
    RequestConfig<AuthControllerForgotPasswordV1MutationRequest>
  > & { client?: Client } = {},
) {
  ...
  >({
    method: "POST",
    url: getAuthControllerForgotPasswordV1Url().url.toString(),
    data: requestData,
    ...requestConfig,
